...
using WebFinalECCNetCore.Models;

namespace WebFinalECCNetCore.Controllers
{
    public class SerieController : Controller
    {
        private readonly LabECCContext _context;

        public SerieController(LabECCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Series != null ? 
                ...
                Problem("Entity set 'LabECCContext.Series'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LabECCContext.Series'  is null.");
            }
            var serie = await _context.Series.FindAsync(id);
            if (serie != null)
            {
